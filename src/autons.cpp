...
void awp_part_two(){
    ...
    chassis.moveToPoint(-30, -47, 1000, {.maxSpeed = 110, .minSpeed = 40, .earlyExitRange = 2});
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);

    chassis.swingToPoint(-19, -22, lemlib::DriveSide::RIGHT, 1000, {.maxSpeed = 100, .minSpeed = 35, .earlyExitRange = 5});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);

    chassis.moveToPoint(-25, -27, 2000, {.maxSpeed = 110, .minSpeed = 35, .earlyExitRange = 3});
    chassis.waitUntil(8);
    //subsystems::matchload::extend();
    chassis.waitUntilDone();

    chassis.moveToPoint(-22, 18, 4000, {.maxSpeed = 100, .minSpeed = 30, .earlyExitRange = 2});
    chassis.waitUntil(5);
    subsystems::matchload::retract();

    chassis.waitUntil(34);
    subsystems::matchload::extend();
    //chassis.turnToPoint(-40, 46, 2000, {.maxSpeed = 100, .minSpeed = 50, .earlyExitRange = 2});
    chassis.moveToPoint(-35, 46.5, 2200, {.maxSpeed = 110, .minSpeed = 30, .earlyExitRange = 1});
    chassis.waitUntilDone();
    chassis.turnToHeading(270, 1000, {.maxSpeed = 100, .minSpeed = 50, .earlyExitRange = 6});
    chassis.waitUntilDone();
    pros::delay(15);
    subsystems::localization::leftDistanceReset(chassis, subsystems::localization::Wall::TOP_Y);
    pros::delay(50);
    chassis.moveToPoint(-24, 47.8, 1000, {.forwards = false, .maxSpeed = 70, .minSpeed = 40});
    ...
    pros::delay(1000); //1300 to 1100
    chassis.setPose(-25, 48, chassis.getPose().theta);
    subsystems::intake::run(subsystems::intake::GoalType::NONE);
    pros::delay(10);
    chassis.moveToPoint(-73.25, 47.5, 1100, {.maxSpeed = 70, .minSpeed = 42, .earlyExitRange = 2});
    chassis.waitUntil(10);
    chassis.cancelMotion();
    subsystems::intake::run(subsystems::intake::GoalType::MEDIUM_GOAL_QUEUE);

    chassis.moveToPoint(-73.25, 47.5, 800, {.maxSpeed = 45, .minSpeed = 30, .earlyExitRange = 2});
    chassis.waitUntilDone();
    chassis.tank(40, 40);
    pros::delay(170);
    chassis.moveToPoint(-6, 7, 2500, {.forwards = false, .maxSpeed = 110, .minSpeed = 75, .earlyExitRange = 2});
    chassis.waitUntil(35);
    chassis.cancelMotion();
    chassis.moveToPoint(-6.7, 8.5, 2500, {.forwards = false, .maxSpeed = 95, .minSpeed = 75, .earlyExitRange = 2});
...
void fourteen_awp(){
    ...
    chassis.setPose(-45.5, -2, 0);
    chassis.moveToPoint(-45.5, 2, 1000, {. minSpeed = 100, .earlyExitRange = 1});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.waitUntilDone();
    chassis.moveToPoint(-45, -45.5, 2500, {.forwards = false, .maxSpeed = 50, .minSpeed = 5, .earlyExitRange = 1});
    chassis.waitUntil(5);
    chassis.cancelMotion();


    chassis.moveToPoint(-45, -45.5, 2500, {.forwards = false, .maxSpeed = 100, .minSpeed = 5, .earlyExitRange = 1});
    chassis.waitUntil(5); //added
    // chassis.cancelMotion(); //added

    subsystems::matchload::extend();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.turnToPoint(-62, -45.5, 2500, {.maxSpeed = 85, .minSpeed = 20,.earlyExitRange = 3});


    // shake in the matchloaer
    chassis.moveToPoint(-64, -45.5, 600, {.maxSpeed = 55, .minSpeed = 45, .earlyExitRange = 1});
    chassis.waitUntilDone();
    chassis.tank(40,40);
    pros::delay(325);
    chassis.tank(0,0);
    ...
    chassis.moveToPoint(-25, -48.5, 1100, {.forwards = false, .maxSpeed = 95, .minSpeed = 50, .earlyExitRange = 2.5});
    chassis.waitUntil(31); //12 to 15
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
...
void seven_ball_left() {
    chassis.setPose(-42, 12.25 ,90 );
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.moveToPoint(-22, 16.5, 4000, {.maxSpeed = 95, .minSpeed = 60, .earlyExitRange = 2});
    ...
    chassis.moveToPoint(-16, 44.25, 1750, {.forwards = false, .maxSpeed = 110, .minSpeed = 55});
    chassis.waitUntil(15);
    chassis.cancelMotion();
    chassis.moveToPoint(-22, 44, 500, {.forwards = false, .maxSpeed = 55, .minSpeed = 45});
    chassis.waitUntil(15);
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
...
void seven_ball_right(){
    ...
    //chassis.waitUntil(8);
    //chassis.cancelMotion();
    chassis.moveToPose(-56, -43, -90, 1500, {.lead = 0.57, .minSpeed = 40, .earlyExitRange = 2});
    chassis.waitUntilDone();

    chassis.turnToPoint(-73.5, -44, 800, {.maxSpeed = 100,.minSpeed = 50,  .earlyExitRange = 4});


    chassis.moveToPoint(-73.5, -44, 500, {.maxSpeed = 55, .earlyExitRange = 1});
    chassis.waitUntilDone();
    chassis.tank(10, 10);
    pros::delay(150);
    chassis.tank(0,0);
    ...
    chassis.moveToPoint(-22, -42.75, 1750, {.forwards = false, .maxSpeed = 110, .minSpeed = 55});
    chassis.waitUntil(15);
    chassis.cancelMotion();
    chassis.moveToPoint(-22, -42.75, 600, {.forwards = false, .maxSpeed = 55, .minSpeed = 45});
...
void left_ml_rush() {
    ...
    chassis.moveToPoint(-45, 45, 2500, {.maxSpeed = 90, .minSpeed = 25, .earlyExitRange = 2});
    subsystems::matchload::extend();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.turnToPoint(-62, 49, 2500, {.maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 3});


    // shake in the matchloaer
    chassis.moveToPoint(-63.75, 48.5, 600, {.maxSpeed = 55, .minSpeed = 55, .earlyExitRange = 1}); //-67.6 to -67.2 and -50 to -49.5
    chassis.waitUntilDone();
    chassis.tank(40,40);
    pros::delay(600); // 350 to 400
    chassis.tank(0,0);
...
void right_ml_rush() {
    ...
    chassis.moveToPoint(-45, -45, 2500, {.maxSpeed = 100, .minSpeed = 40, .earlyExitRange = 2});
    subsystems::matchload::extend();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.turnToPoint(-62, -49, 2500, {.maxSpeed = 85, .minSpeed = 25,.earlyExitRange = 2});


    // shake in the matchloaer
    chassis.moveToPoint(-54, -48.5, 600, {.maxSpeed = 55, .minSpeed = 55, .earlyExitRange = 1}); //-67.6 to -67.2 and -50 to -49.5
    chassis.waitUntilDone();
    chassis.tank(40,40);
    pros::delay(400); // 350 to 400
    chassis.tank(0,0);


    chassis.moveToPoint(-24, -48.5, 1900, {.forwards = false, .maxSpeed = 105, .minSpeed = 65, .earlyExitRange = 2});
    chassis.waitUntilDone();
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
...
void seven_counter(){
    ...
    // Y changed from 19 to -19
    chassis.moveToPoint(-11, -19, 4000, {.maxSpeed = 85, .minSpeed = 30});
    ...
    // Y changed from 35 to -35
    chassis.moveToPoint(0.5, -39.5, 2500, {.maxSpeed = 60, .minSpeed = 30});
    chassis.waitUntilDone();
    subsystems::matchload::extend();

    pros::delay(250);

    // Y changed from 25 to -25
    chassis.moveToPoint(-20, -25, 2000, {.forwards = false, .maxSpeed = 110, .minSpeed = 40, .earlyExitRange = 1.5});
    chassis.waitUntilDone();

    // Y changed from 48 to -48
    //chassis.moveToPoint(-41, -45.5, 4000, {.forwards = false, .maxSpeed = 110, .minSpeed = 30, .earlyExitRange = 1});
    //chassis.waitUntilDone();
    chassis.moveToPoint(-35, -42, 2000, {.forwards = false, .maxSpeed = 110, .minSpeed = 40, .earlyExitRange = 1.5});

    chassis.waitUntilDone();
    chassis.turnToPoint(-63.25, -42.5, 1100, {.maxSpeed = 95, .minSpeed = 42, .earlyExitRange = 6});


    chassis.moveToPoint(-63.25, -42.5, 700, {.maxSpeed = 65, .minSpeed = 42, .earlyExitRange = 2});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.waitUntilDone();
    ...
    //chassis.moveToPoint(-50, -46, 2000, {.forwards = false, .maxSpeed = 95, .minSpeed = 65, .earlyExitRange = 2});
    //chassis.waitUntilDone();
    subsystems::wing::toggle();

    chassis.turnToHeading(225, 1000, {.maxSpeed = 100, .minSpeed = 50, .earlyExitRange = 5});
    chassis.moveToPoint(-26, -33, 2000, {.forwards = false, .maxSpeed = 100, .minSpeed = 50, .earlyExitRange = 3.5});
    subsystems::matchload::retract();

    chassis.waitUntilDone();
    subsystems::wing::toggle();

    chassis.moveToPoint(0.5, -35, 2000, {.forwards = false, .maxSpeed = 95, .minSpeed = 50, .earlyExitRange = 2});
    chassis.waitUntilDone();
    pros::delay(75);
    subsystems::wing::retract();
    chassis.moveToPoint(-35, -38, 1800, {.maxSpeed = 95, .minSpeed = 42, .earlyExitRange = 2});

    chassis.moveToPoint(-19, -43, 1550, {.forwards = false, .maxSpeed = 60, .minSpeed = 50, .earlyExitRange = 1});
    chassis.waitUntilDone();
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL);
    pros::delay(50);
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
    ...
    chassis.setPose(-24, -43, chassis.getPose().theta);
    chassis.moveToPoint(-30.25, -43, 1100, {.maxSpeed = 85, .minSpeed = 42, .earlyExitRange = 2});
    chassis.swingToPoint(-15.5, -14.5, lemlib::DriveSide::RIGHT, 900, { .maxSpeed = 100, .minSpeed = 65, .earlyExitRange = 10});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.moveToPoint(-15.5, -14.5, 2000, {.maxSpeed = 95, .minSpeed = 60, .earlyExitRange = 5});

    chassis.moveToPoint(-7, -7, 825, {.maxSpeed = 55, .minSpeed = 40, .earlyExitRange = 3});
    subsystems::matchload::retract();
    chassis.waitUntil(2);
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL);
    chassis.waitUntilDone();
    pros::delay(1000);
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL_DOWN);
    ...
    chassis.moveToPoint(-30, -28, 2000, {.forwards = false, .maxSpeed = 85, .minSpeed = 25, .earlyExitRange = 3});
    chassis.waitUntilDone();
    subsystems::wing::retract();
    subsystems::midGoalDescore::retract();

    // Heading: 180 - 86 = 94
    chassis.turnToPoint(-4, -38, 1000, {.forwards = false, .maxSpeed = 90, .minSpeed = 30, .earlyExitRange = 4});
    chassis.waitUntilDone();

    // Y changed from 37 to -37
    chassis.moveToPoint(-4, -38 , 5000, {.forwards = false, .maxSpeed = 65, .minSpeed = 20});
    chassis.waitUntilDone();

    // Mirrored tank drive: Swap values to arc the opposite way
    chassis.tank(-30, 15);
    pros::delay(100000);
...
void right_9_first_part(){
    ...
    //chassis.moveToPoint(-41, -45.5, 4000, {.forwards = false, .maxSpeed = 110, .minSpeed = 30, .earlyExitRange = 1});
    //chassis.waitUntilDone();
    chassis.moveToPoint(-35, -44, 2000, {.forwards = false, .maxSpeed = 110, .minSpeed = 40, .earlyExitRange = 1.5});

    chassis.waitUntilDone();

    // Y changed from 48 to -48
    chassis.moveToPoint(-16, -44.5, 1250, {.forwards = false, .maxSpeed = 70, .minSpeed = 30});
    ...
    // Y changed from 46.25 to -46.25
    chassis.moveToPoint(-73.25, -46, 1100, {.maxSpeed = 53, .minSpeed = 42, .earlyExitRange = 2});
    chassis.waitUntil(6);
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.waitUntilDone();
    ...
    // Y changed from 47 to -47
    chassis.moveToPoint(-45, -47, 3000, {.forwards = false, .maxSpeed = 90, .minSpeed = 20, .earlyExitRange = 1.5});
    chassis.waitUntilDone();


    // Y from 8 to -8
    // Heading: 180 - 315 = -135 (which is 225)
    chassis.moveToPoint(-5, -7, 3500, {.maxSpeed = 95, .minSpeed = 30});
    subsystems::matchload::retract();
...
void right_9_w_wing(){
    ...
    right_9_first_part();
    pros::delay(500);
    // Y changed from 31 to -31
    chassis.moveToPoint(-32, -33, 2000, {.forwards = false, .maxSpeed = 85, .minSpeed = 25, .earlyExitRange = 3});
    chassis.waitUntilDone();
    subsystems::wing::retract();
    subsystems::midGoalDescore::retract();

    // Heading: 180 - 86 = 94
    chassis.turnToPoint(-4, -41, 1000, {.forwards = false, .maxSpeed = 90, .minSpeed = 30, .earlyExitRange = 4});
    chassis.waitUntilDone();

    // Y changed from 37 to -37
    chassis.moveToPoint(-4, -41 , 5000, {.forwards = false, .maxSpeed = 60, .minSpeed = 20});
    chassis.waitUntilDone();
...
void right_12(){
    ...
    chassis.moveToPoint(-20, -20, 2000, {.forwards = false, .maxSpeed = 85, .minSpeed = 25, .earlyExitRange = 3});
    chassis.moveToPoint(-20, 20, 2000, {.maxSpeed = 85, .minSpeed = 25, .earlyExitRange = 3});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.waitUntil(26);
    subsystems::matchload::extend();

    chassis.moveToPoint(-5, 5, 2000, {.forwards = false, .maxSpeed = 65, .minSpeed = 25, .earlyExitRange = 3});
    chassis.waitUntil(2);
    subsystems::intake::run(subsystems::intake::GoalType::MEDIUM_GOAL);
    chassis.waitUntilDone();
    pros::delay(900);

    chassis.moveToPoint(-14, 14, 1250, {.maxSpeed = 85, .minSpeed = 25, .earlyExitRange = 3});
    chassis.waitUntil(5);
    subsystems::midGoalDescore::extend();
    chassis.moveToPoint(-5, 5, 2000, {.forwards = false, .maxSpeed = 65, .minSpeed = 25, .earlyExitRange = 3});
    chassis.waitUntilDone();
...
void left_43_first_part() {
    ...
    pros::delay(70);
    // Y changed from 48 to -48
    chassis.moveToPoint(-20, 47, 1200, {.forwards = false, .maxSpeed = 70, .earlyExitRange = 1});
    ...
    chassis.waitUntilDone();
    chassis.tank(40, 40);
    pros::delay(200); // 600 to 450
    chassis.tank(0, 0);
    chassis.moveToPoint(-50, 47, 2500, {.forwards = false, .minSpeed = 20, .earlyExitRange = 1});
    chassis.moveToPose(-6.5, 6.5, 315, 2000, {.forwards = false, .minSpeed = 40, .earlyExitRange = 1});
    subsystems::matchload::retract();
    chassis.waitUntilDone();
    subsystems::intake::run(subsystems::intake::GoalType::MEDIUM_GOAL);
    chassis.tank(-10, -10);
    ...
    subsystems::intake::run(subsystems::intake::GoalType::MEDIUM_GOAL);
    pros::delay(1100); // 1500 to 1000
    chassis.moveToPoint(-15.5, 18, 1000, {.minSpeed = 20, .earlyExitRange = 3});
    chassis.waitUntil(5);
    subsystems::midGoalDescore::extend();
    chassis.waitUntilDone();
...
void right_43_first_part() {
    subsystems::wing::extend();
    chassis.setPose(-45.5, -17.5, 180);
    chassis.moveToPoint(-45, -45, 2500, {.maxSpeed = 90, .minSpeed = 25, .earlyExitRange = 1});
    subsystems::matchload::extend();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.turnToPoint(-62, -49, 2500, {.maxSpeed = 85, .minSpeed = 25,.earlyExitRange = 2});
    ...
    chassis.cancelMotion();
    chassis.moveToPoint(-23, -48.5, 500, {.forwards = false, .maxSpeed = 70, .minSpeed = 50, .earlyExitRange = 1});
    chassis.waitUntil(6);
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
    ...
    chassis.turnToPoint(-17.5, -17.5, 900, { .maxSpeed = 100, .minSpeed = 65, .earlyExitRange = 10});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.moveToPoint(-17.5, -17.5, 2000, {.maxSpeed = 105, .minSpeed = 60, .earlyExitRange = 5});

    chassis.moveToPoint(-8.5, -8.5, 750, {.maxSpeed = 55, .minSpeed = 40, .earlyExitRange = 5});
    subsystems::matchload::retract();
    chassis.waitUntil(1);
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL);
    chassis.waitUntilDone();
...
void right_43_w_wing() {
    ...
    chassis.moveToPoint(-32, -38, 2000, {.forwards = false, .maxSpeed = 100, .minSpeed = 45, .earlyExitRange = 3});
    chassis.waitUntilDone();
    subsystems::wing::retract();
    subsystems::midGoalDescore::retract();

    // Heading: 180 - 86 = 94
    chassis.turnToPoint(-4, -46, 1000, {.forwards = false, .maxSpeed = 100, .minSpeed = 50, .earlyExitRange = 6});
    chassis.waitUntilDone();

    // Y changed from 37 to -37
    chassis.moveToPoint(-4, -46, 5000, {.forwards = false, .maxSpeed = 80, .minSpeed = 20});
    chassis.waitUntilDone();
...
void wing_balls_macro() {
    ...
    chassis.moveToPoint(-15, -47.5, 1300, {.maxSpeed = 110, .minSpeed = 100, .earlyExitRange = 1}); //-35.75 to -37.5

    chassis.moveToPoint(-25, -37, 2000, {.minSpeed = 90, .earlyExitRange = 1.5});
    chassis.turnToHeading(283, 400, {.minSpeed = 30, .earlyExitRange = 10});
    chassis.waitUntilDone();
}
...
void wing_balls() {
    ...
    */
    ...
    chassis.moveToPoint(-17, -47.5, 1300, {.maxSpeed = 110, .minSpeed = 85, .earlyExitRange = 1}); //-35.75 to -37.5

    chassis.moveToPoint(-27, -34.5, 2000, {.minSpeed = 20, .earlyExitRange = 1.5});
    chassis.turnToHeading(265, 500, {.minSpeed = 30, .earlyExitRange = 10});
    chassis.moveToPoint(-1, chassis.getPose().y, 2000, {.forwards = false, .maxSpeed = 90, .minSpeed = 40, .earlyExitRange = 1.5});
    chassis.waitUntilDone();
...
void skillsOne(){
    ...
    */
    ...
    pros::delay(1200); //2000 to 1650 decrease if need more time to 1700
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);

    subsystems::matchload::extend();

    //move away from center goal
    chassis.moveToPoint(-40, 44.75, 2000, {.maxSpeed = 80, .earlyExitRange = 1});
    chassis.waitUntilDone();

    chassis.turnToPoint(-68, 45.75, 1600, {.maxSpeed = 60, .minSpeed = 15, .earlyExitRange = 5}); //44.5 to 46


    chassis.moveToPoint(-68, 45.75, 1000, {.maxSpeed = 60, .minSpeed = 60, .earlyExitRange = 1.5}); //44.5 to 46
    subsystems::wing::toggle();
...
void itCouldWork(){
    ...
    chassis.waitUntilDone();
    chassis.tank(40,40);
    pros::delay(425); // 350 to 400
    chassis.tank(-60,-60);
    pros::delay(100);
    subsystems::matchload::retract();

    chassis.turnToHeading(-180, 1000, {.maxSpeed = 90, .minSpeed = 80, .earlyExitRange = 10});
    chassis.moveToPose(-17.5, 27.5, 90, 2200, {.maxSpeed = 120, .minSpeed = 100, .earlyExitRange = 1});
    chassis.waitUntil(20);
    subsystems::matchload::extend();

    chassis.turnToHeading(315, 2000, {.maxSpeed = 60, .minSpeed = 55, .earlyExitRange = 5});
    chassis.waitUntil(90);
    chassis.moveToPose(-11, 17, 315, 2000, {.forwards = false, .maxSpeed = 60});
    chassis.waitUntil(5);
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL);
    ...
    subsystems::intake::run(subsystems::intake::GoalType::MEDIUM_GOAL);
    pros::delay(600);
    chassis.moveToPoint(-16, 40,  1500, {.maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 3});
    ...
    chassis.moveToPoint(-11, 48,  1500, {.earlyExitRange = 0.5});
    chassis.waitUntil(6);
    ...
    chassis.turnToHeading(90,  1000, {.minSpeed = 20, .earlyExitRange = 4});
    subsystems::wing::extend();

    chassis.waitUntilDone();

    chassis.moveToPoint(-25, 50,  1500, {.forwards = false, .maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 3});

    chassis.waitUntilDone();

    pros::delay(50);
    chassis.turnToHeading(90, 1500, {.maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 8});


    chassis.moveToPoint(-8, 50,  500, {.maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 3});
    ...
    chassis.moveToPoint(-40, 49,  1500, {.forwards = false, .maxSpeed = 85, .minSpeed = 15,.earlyExitRange = 3});
    subsystems::wing::retract();

    chassis.waitUntilDone();

    chassis.swingToHeading(270, lemlib::DriveSide::LEFT, 2000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .minSpeed = 40, .earlyExitRange = 5});

    chassis.waitUntilDone();

    chassis.moveToPoint(-25, 58, 1500, {.forwards = false, .maxSpeed = 70, .minSpeed = 50});
    chassis.waitUntil((10));
    subsystems::intake::run(subsystems::intake::GoalType::LONG_GOAL);
    chassis.waitUntilDone();
    chassis.tank(-127, -127);
    ...
    chassis.moveToPoint(-40, 46, 500, {.minSpeed = 80, .earlyExitRange = 2});
    chassis.waitUntilDone();
    chassis.moveToPoint(-13, 10, 2500 , {.forwards = false, .minSpeed = 80, .earlyExitRange = 2});
    chassis.waitUntil(5);
    subsystems::midGoalDescore::extend();

    chassis.waitUntil(20);
    chassis.cancelMotion();
    chassis.moveToPoint(-13, 10, 2500 , {.forwards = false, .maxSpeed = 70, .minSpeed = 60, .earlyExitRange = 2});
...
void skillsThree(){
    ...
    chassis.waitUntil(20);
    chassis.cancelMotion();
    chassis.moveToPoint(67.2, 47, 1100, {.maxSpeed = 45, .minSpeed = 40, .earlyExitRange = 1.5});

    chassis.waitUntilDone();

    // into matchloader 2
    chassis.tank(55,55); // both nums to 25 from 20
...
void skillsFour() {
    ...
    */
    ...
    chassis.moveToPoint(60.5, 30, 2000, {.maxSpeed = 65, .minSpeed = 10, .earlyExitRange = 1});
    chassis.waitUntilDone();

    chassis.swingToHeading(170, lemlib::DriveSide::RIGHT, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .minSpeed = 30, .earlyExitRange = 3});
    // clear park zone
    chassis.moveToPoint(69, 25, 1000, {.maxSpeed = 90, .minSpeed = 85, .earlyExitRange = 1.5});
    chassis.waitUntil(2);
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.moveToPoint(68, -15, 3000, {.maxSpeed = 90, .minSpeed = 70}); //69 to 68 and 4000 to 3000 and 90 to 85 and -17 to -18.5
    chassis.waitUntilDone();
    pros::delay(50); //400 to 300
    subsystems::localization::leftDistanceReset(chassis, subsystems::localization::Wall::RIGHT_X);
    pros::delay(100); //400 to 300
    ...
    // getting extra ball
    chassis.moveToPose(35.5, -22, 270, 4000); //35.25 to 36
    chassis.waitUntilDone();

    //turn toward middle goal
    chassis.moveToPoint(24, -24, 1000, {.forwards = false, .minSpeed = 20, .earlyExitRange = 1});
    chassis.waitUntilDone();
    //move toward middle goal
    subsystems::matchload::extend();
    // make lead from 0.3 to 0.8
    chassis.moveToPose(12, -11, 135, 1350, {.forwards = false, .earlyExitRange = 1.5});
    chassis.waitUntilDone();
    ...
    chassis.moveToPoint(40, -47, 2000, {.maxSpeed = 80, .earlyExitRange = 0.5});
    chassis.waitUntilDone();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
...
void skillsFive() {
    ...
    // move to clear park zone
    chassis.moveToPoint(61.5, 30, 1500, {.maxSpeed = 65, .minSpeed = 30, .earlyExitRange = 2}); //61.5 to 61
    chassis.waitUntilDone();

    chassis.swingToHeading(170, lemlib::DriveSide::LEFT, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .minSpeed = 30, .earlyExitRange = 3});
    // clear park zone
    chassis.moveToPoint(65, 22, 4000, {.maxSpeed = 97, .minSpeed = 87, .earlyExitRange = 1.5}); //try 4.25 to 5 if doesn't work

    chassis.moveToPoint(68, 16.7, 40000, {.maxSpeed = 100, .minSpeed = 92, .earlyExitRange = 1.5}); //try 4.25 to 5 if doesn't work
    chassis.turnToHeading(180, 1000, {.maxSpeed = 100, .minSpeed = 92, .earlyExitRange = 1.5});
    subsystems::matchload::extend();
    chassis.waitUntilDone();
    pros::delay(500);


    chassis.moveToPoint(70, 9.7, 40000, {.maxSpeed = 100, .minSpeed = 92, .earlyExitRange = 1.5}); //try 4.25 to 5 if doesn't work

    */

    chassis.moveToPose(66.25, 14.5, 180, 5000, {.lead = 0.2, .minSpeed = 60});
    chassis.waitUntilDone();
    chassis.turnToHeading(167, 1000, {.minSpeed = 50, .earlyExitRange = 5});
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);

    //subsystems::matchload::extend();

    chassis.moveToPoint(68.5, 8, 2000, {.minSpeed = 115});
...
void left_9_first_part() {
    ...
    chassis.waitUntilDone();
    subsystems::matchload::retract();
    chassis.moveToPoint(-2.5, 35, 2000, {.maxSpeed = 60, .minSpeed = 30,  .earlyExitRange = 1});
    //chassis.waitUntil(17);
    chassis.waitUntilDone();
    subsystems::matchload::extend();
    ...
    chassis.moveToPoint(-20, 25, 2000, {.forwards = false, .maxSpeed = 110, .minSpeed = 10,  .earlyExitRange = 0.1});
    chassis.waitUntilDone();
    ...
    chassis.moveToPoint(-41, 48, 4000, {.forwards = false, .maxSpeed = 110, .minSpeed = 10,  .earlyExitRange = 0.25}); //46.5 to 47
    chassis.waitUntilDone();
    chassis.moveToPoint(-35, 48, 1000, {.forwards = false, .maxSpeed = 110, .minSpeed = 30,  .earlyExitRange = 1}); //46.5 to 47

    chassis.waitUntilDone();
    //chassis.turnToHeading(270, 1000, {.minSpeed = 70, .earlyExitRange = 3});
    //chassis.waitUntilDone();
    chassis.moveToPoint(-16, 48, 1000, {.forwards = false, .maxSpeed = 70});
    ...
    subsystems::intake::stop();
    subsystems::intake::run(subsystems::intake::GoalType::HOLD_BALLS);
    chassis.moveToPoint(-73.5, 46.25, 1100, {.maxSpeed = 53, .minSpeed = 42, .earlyExitRange = 2});
    chassis.waitUntilDone();
    chassis.tank(40, 40);
    pros::delay(650); // 600 to 450
    chassis.tank(0, 0);
    chassis.moveToPoint(-50, 47, 300, {.forwards = false});
    chassis.moveToPose(-5, 8, 315, 2500, {.forwards = false});
    ...
    chassis.moveToPose(-5, 8, 315, 3000, {.forwards = false, .maxSpeed = 80, .minSpeed = 65}); //-6.25 to -7.5
    chassis.waitUntilDone();
}
...
void left_9_wing() {
    ...
    chassis.moveToPoint(-31, 31, 2000, {.maxSpeed = 100, .minSpeed = 20, .earlyExitRange = 1}); //35.25 to 35.5
    chassis.waitUntilDone();
    subsystems::wing::retract();
    ...
    chassis.turnToHeading(86, 1000, {.minSpeed = 30, .earlyExitRange = 2}); //91 to 90
    chassis.waitUntilDone();

    chassis.moveToPoint(-4, 37, 5000);
    chassis.waitUntilDone();
    chassis.tank(30, -15);
    pros::delay(100000);
}
...
void endMid(){
    ...
    chassis.waitUntilDone();
    chassis.tank(40,40);
    pros::delay(300); // 350 to 400
    chassis.tank(-60,-60);
    pros::delay(100);
    subsystems::matchload::retract();

    chassis.moveToPoint(-22.5, 22.5, 2200, {.maxSpeed = 80, .minSpeed = 50, .earlyExitRange = 1});
    chassis.waitUntil(20);
    subsystems::matchload::extend();

    chassis.turnToHeading(315, 2000, {.maxSpeed = 60, .minSpeed = 35, .earlyExitRange = 5});
    chassis.waitUntil(90);
    chassis.moveToPoint(-8, 12, 2000, {.forwards = false, .maxSpeed = 60});
    chassis.waitUntil(5);
    subsystems::intake::run(subsystems::intake::GoalType::LOW_GOAL);
    ...
    //chassis.moveToPose(-6.75, 8.75, 315, 3000, {.forwards = false, .maxSpeed = 55, .minSpeed = 50});
    //chassis.waitUntilDone();
    chassis.tank(-50, -50);
    pros::delay(100);
    chassis.tank(-30, -30);
